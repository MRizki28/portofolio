                ...
                <div class="modal-body">
                    <form id="formTambah" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="date_publish" id="date_publish"
                                placeholder="Input Here">
                        </div>
                        <div class="form-group">
                            <label for="date_expaire">date expaire</label>
                            <input type="date" class="form-control" name="date_expaire" id="date_expaire"
                                placeholder="Input Here">
                        </div>
                        <div class="form-group">
                            <label for="learn1">learn 1</label>
                            <input type="learn1" class="form-control" name="learn1" id="learn1"
                                placeholder="Input Here">
                        </div>
                        <div class="form-group">
                            <label for="learn2">learn 2</label>
                            <input type="learn2" class="form-control" name="learn2" id="learn2"
                                placeholder="Input Here">
                        </div>
                        <div class="form-group">
                            <label for="learn3">learn 3</label>
                            <input type="learn3" class="form-control" name="learn3" id="learn3"
                                placeholder="Input Here">
                        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.data, function(index, item) {
                        ...
                        tableBody += "<td><img src='/uploads/certificate/" + item.image +
                            "' alt='" +
                            item.title +
                            "' class='img-thumbnail' style='width: 200px'></td>";
                        tableBody += "<td>" + item.date_publish + "</td>";
                        tableBody += "<td>" + item.date_expaire + "</td>";
                        tableBody += "<td>" + item.learn1 + "</td>";
                        tableBody += "<td>" + item.learn2 + "</td>";
                        tableBody += "<td>" + item.learn3 + "</td>";
                        tableBody += "<td>" +
